 ...
 * @author troll
 */
public class FrConMarca extends javax.swing.JInternalFrame {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(rbAZ)
                    .addComponent(rbNome)
                    .addComponent(txtMarcaPesq, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btListar))
                .addGap(13, 13, 13)
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        try {
            marca = new MarcaDao();
            if (!txtMarca.getText().isEmpty() && idSelec != -1) {
    ...
    private void btListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btListarActionPerformed
        ...
        if (rbTodos.isSelected()) {
            ...
            try {
                marca = new MarcaDao();
                for (Marca m : marca.readPesq(txtMarcaPesq.getText())) {
                    modelo.addRow(new Object[]{
                    m.getId(),
                    m.getMarca(),
                    });
